...
void encoder5()
{
  currStateclk5=digitalRead(clk5);
if(currStateclk5 != lastStateclk5 && currStateclk5 == 1)
 {
  if(digitalRead(dt5) != currStateclk5 )
  {
    counter5--;
    currDir5="Anti clockwise";
    }
    else
    {
      counter5++;
  ...
  Serial.println("Direction of encoder5:");
  Serial.print(currDir5);
  Serial.println("Value of counter5:");
